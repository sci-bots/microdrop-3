...
//	        '<h3>Clicked Item: <span id="log-span"></span></h3>');
        ...
        contextArea.node.appendChild(document.getElementById("container"));
           console.log(document.getElementById("canvasID"));
        //contextArea.node.appendChild(document.getElementsByTagName("canvas"));
           
        var cmSource = new phosphor_widget_1.Widget();
        cmSource.title.text = 'Source';
	    var cmCss = new phosphor_widget_1.Widget();
	    cmCss.title.text = 'CSS';
           cmCss.node.appendChild(gui.domElement);
